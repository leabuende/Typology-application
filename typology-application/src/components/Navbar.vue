<template>
  <div
    ...
    v-bind:class="{ 'nav-hover': hoverlink[0] || hoverlink[1] }"
  >
  <div class="row w-100">
    ...
    <div class="nav-links col-4 d-none d-sm-flex">
      <div class="box d-flex">
        <div>
          <div class="nav-link products" @mouseover="$set(hoverlink, 0, true)"
              @mouseleave="$set(hoverlink, 0, false)">
            <a
              class="title-font product-title"
